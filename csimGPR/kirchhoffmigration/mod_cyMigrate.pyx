...
def cyMigrate(np.ndarray[np.float32_t, ndim=3] data,int nx, int nz,float dt,float dx,float dz,float dcdp,float v,np.ndarray[np.float32_t, ndim=1] offsets,int nsamples,int ntrc,int noff, int ioff=0):
